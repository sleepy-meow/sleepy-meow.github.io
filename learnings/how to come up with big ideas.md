...
Coming up with something new involves connecting things we know, noticing what we're missing, and exploring what might be possible. In a team, much of that happens _between people_.
...
This is why the [[free flow of information]] matters. People need enough context to notice where their knowledge could help, including outside their own assigned work. As teams grow, keeping those connections alive takes more deliberate effort: [[team of teams + innovation|great teams also need to be able to think together]].

## We can only think smarter if others in the room speak their minds
“This might be a stupid question, but…” can be the beginning of something useful. It can also be the point where someone decides to stay quiet. If every contribution has to arrive polished and defensible, we miss the ideas that needed someone else's perspective before they could make sense.
...
That takes [[how to ask the right questions|useful questions]], honest feedback, and a willingness to [[how to question your own thinking|reconsider our own thinking]]. Then we need to try something small enough to [[the science of failing well|learn from if it doesn't work]], and [[a learning mindset|share what we discover]].
...
The only way is to create an environment in which ideas can emerge. 
