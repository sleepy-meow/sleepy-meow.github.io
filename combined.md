...
Most of these skills aren’t exclusive to any job title, or even limited to the workplace. They’re about how we listen, understand each other, and work through things together. We aren’t born knowing how to do all of this, and we can get better with practice.
...
<!-- learnings/feeling safe and trusted.md -->
...
> We can't demand people to trust us, or instruct them to come up with big ideas. and certainly can't demand people to cooperate. these are always results of feeling safe and trusted.
 ...
 Psychological safety: *a team climate in which people feel safe to challenge the thinking of those who have the power to throw them under the bus.*
...
**The usual gap: feeling less safe than you actually are.** The default bias, most people systematically underweight how safe it really is. A leader can't just be safe: they have to actively, repeatedly demonstrate it, because people walk in assuming risk.
...
A lack of psychological safety effectively prevents bad news from traveling upwards, creating an illusion of success that eventually turns into serious business failures. Yet many organizational leaders genuinely believe that "no news" means that things are going well.
...
For practical ways to build these conditions, see [how to psychological safety](#how-to-psychological-safety)
#### Resources
...
A few simple phrases can make a workplace feel more psychologically safe (Acknowledging that you are a fallible human being gives others permission to do the same.)
...
_I'm sorry._
 ...
 You can also signal interest and availability with questions like:
...
1. **Speak up when you safely can.**  
    Raising an awkward point (i.e. being the village idiot) gives others permission to do the same. One voice often makes the second easier.
    
    Pro tip: even a genuinely silly question can lower the bar for others to ask other things as well.

1. **Be the second voice.**  
...
2. **Don't leave the messenger alone afterwards.**  
...
3. **Practice openness with peers.**  
    Share unfinished thoughts, ask unpolished questions, and admit uncertainty. It lowers the pressure to perform certainty.
    
4. **Ask instead of assert.**  
...
7. **Build lateral connections.**  
    Maintain relationships across teams so information has more than one route to travel.
    
8. **Compare notes, then raise it together.**  
...
<!-- learnings/a learning mindset.md -->
...
In complex work, we rarely know every step in advance, and even the goal can change along the way. Learning and adapting are part of making progress. (Creativity and innovation are, by definition, messy and unpredictable, and so is the world around us)

#### The curiosity gap

> *"In the absence of data we will always make up stories - it’s how our brains function."*

Curiosity starts when we notice a gap between what we know and what we want to understand. A good question is what creates the gap that pulls people into learning.
...
A learning mindset shows up in how we work: asking questions, testing assumptions, seeking feedback, and changing our minds when we discover something new.

But individual learning doesn’t automatically become organizational learning. We need to share what surprised us, what didn’t work, and what we would do differently, so others can build on it.

The question then becomes not just _“what did we learn?”_, but _“what will we do differently, and who else could benefit from knowing?”_
...
Finding a good idea often means trying things that don’t work. Sometimes those attempts help us refine an idea; sometimes they reveal something we weren’t looking for.
...
Before deciding how to respond to a failure, we need to understand what kind it was. In the book *The Right Kind of Wrong*, amy edmondson defines three categories of failures:

1. **Preventable:** deviation from a known good procedure in routine work. Never good news. Fix with training and system design.
2. **Complex:**  a novel confluence of factors in a familiar system, but not preventable in the conventional sense. Respond by analyzing the system, not the person.
3. **Intelligent:**  Useful when it tests a worthwhile idea and gives us information we can act on


#### Make it safer to experiment
Reducing avoidable failures can give us more room to try new things. When a small mistake is less likely to cause serious harm, we can spend less energy worrying about what might go wrong and more on exploring what might work.

One approach is to layer safeguards. The Swiss cheese model illustrates this: every layer has gaps, but another layer can catch what slips through. The layers reduce the chance that a mistake turns into a larger failure.

<img src="pasted%20images/Pasted%20image%2020260820092041.png" alt="Pasted image 20260820092041.png" width="384">

We can also make mistakes easier to recover from. An undo button, for example, lets us experiment without losing our work.

The aim is to provide enough protection for people to explore, without making experimentation unnecessarily difficult.

Failing well means being thoughtful about what we try, limiting the potential downside, and using what we learn to decide what to do next.
...
If you can't clearly articulate what behavior you're addressing, that's a sign the feedback is suspect and needs more thought.

**Is the feedback contextual?**  
Have you identified the mitigating factors that may be driving the behavior? This is why it matters to know your people. Without a basic understanding of the personal or professional challenges they're facing, you can't know how those challenges are shaping their performance.

**Who is benefiting from the feedback?**  
There should be an obvious answer here. Feedback should benefit the organization, yes—but in the moment of delivery, it must benefit the recipient. Character assassinations aren't feedback. Frustrated outbursts aren't feedback, because the beneficiary isn't the recipient. Before delivering feedback, be sure you can say—with a sound mind—that the recipient is the primary beneficiary, and that none of this is driven by your own needs.

**Is the feedback useful now?**  
When you observe a notable behavior, follow up promptly—but that doesn't always mean delivering feedback on the spot. Some tense moments need to cool first. Still, don't let the moment pass entirely. Feedback loses impact with time and the association between act and consequence weakens.

**Is the feedback real?**  
Do you have an accurate, comprehensive understanding of the behavior you're targeting? Or have you made an assumption, inferred intent, skipped the benefit of the doubt? You may not have the full picture in advance, but feedback should avoid supposition and conjecture as much as possible.

**Is the feedback cruel?**  
You're not obligated to make feedback feel good—critical feedback often doesn't. It can dent the ego and wound. But it should never be cruel, never delivered with harm as the intent. There's a difference between tough feedback that hurts but develops, and feedback meant to leave a permanent scar.
...
part 1/3: [clear is kind](#clear-is-kind)
##### Anonymous feedback
...
*"What am I missing?"*
*"Where might I be wrong about this?"*
*"I may have missed something here — what are you seeing?"*
These lower the risk of looking ignorant/incompetent by going first.

*"What might we be missing?"*
*"What other ideas could we generate?"*
*"Who has a different perspective?"*
*"What does this look like from where you sit?"*
Questions that broaden and explicitly make room for more perspectives.

*"What leads you to think so?"*
*"Can you give me an example?"*
*"Help me understand…"*
Questions that deepen show you're genuinely interested, which conveys respect.

*"What concerns you about this?"*
*"What are we not talking about that we should be?"*
*"What would have to be true for this to go wrong?" / "If this fails, where will it have failed?"*
These directly invite concerns and dissent (make bad news safe)

*"What can I do to help?"*
*"What are you up against?"*
*"What are your concerns?"*
*"What does support from me look like?"*
Questions of interest and availability

*"What did we learn from this?"*
*"What would we do differently next time?"*
These reframe a mistake as material to learn

#### things to avoid
**Rhetorical questions (a statement in disguise)**
*"Don't you think we should just ship it?"*
*"Isn't it obvious this is the right call?"*
You're not seeking an answer, you're announcing your view. People hear the expected reply and stop thinking. → Better: "What are the risks of shipping now vs. waiting?"

**Leading questions**
*"You're on board with this, right?"*
*"Wouldn't you agree this is the best option?"*
it assumes the answer and signals the "correct" one, so you learn what people think you want, not what they actually think. → Better: "How are you feeling about this?" / "Help me understand your reaction."
...
too broad to engage — a "powerful question" (World Café) channels attention and focuses inquiry; this does the opposite, so people default to "looks good." → Better: "What's the weakest part of this proposal?"

**The double-barrelled / loaded question**
*"Why are we still using this broken process, and who approved it?"*
stacks multiple questions plus a buried accusation, so people answer the safest part or freeze.
...
| ------------------ | ------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| the answer         | lives in the room; surfaces through the process                    | already decided; the session delivers/ratifies it                                |
| fixed in advance   | only the *question*                                                | the *conclusion*                                                                 |
| facilitator's role | host — holds space                                                 | director — steers to the destination                                             |
| what it produces   | ownership and commitment                                           | compliance and alignment                                                         |
| best when          | the problem is *adaptive* — no known answer, needs buy-in to stick | the problem is *technical* — known answer, clear constraints, speed matters      |
...
Low-stakes disagreements give us somewhere to practise: making a case, hearing objections, changing our minds, and continuing to get along afterwards.
...
This connects to [predictability and psychological safety](#feeling-safe-and-trusted). Each disagreement is an opportunity to demonstrate that honesty is welcome. How people respond—especially those with more power—shapes what others will feel able to say next.
...
People can have different ideas about what respectful disagreement looks like. For one person, openly challenging an idea signals interest and engagement. For another, the same exchange can feel embarrassing or damaging to the relationship. Erin Meyer explores this in the culture map.

A few differences are worth paying attention to:

- **How directly disagreement is expressed.** “I'm not sure that will be easy” may carry a much stronger objection than the listener realises. Equally, “I disagree” may be intended as an ordinary contribution to the discussion.
...
> I agree to practice empathy, screw it up, circle back, clean it up, and try again. (Brene Brown, Dare to Lead)

Circling back is a specific move rather than a vague intention: name what you did, resist explaining why it was justified, and ask for another attempt. *“You raised something hard and I got defensive instead of listening. Could we try that again?”* Treating an apology as a skill to practise, backed by different behaviour next time, is more useful than treating it as something you concede once you've run out of arguments.
...
> [!TIP] Oren Jay Sofer - [Say What You Mean](https://www.orenjaysofer.com/book) (mindful nonviolent communication, active listening, and common humanity)
...
> You can e-mail everyone a list of the team members' types. This is helpful because if they don't remember one another's profiles, they aren't going to be able to use them.
> 
> You should also encourage, or even require, that team members keep any reference material or collateral from the session on their desks back at work, rather than in a drawer or on a bookshelf. This increases the likelihood that they'll refer to it later, and that others will ask them about it.
