...
# cognitive biases & AI
While LLMs can be useful to find the name of a specific bias, it's good practice to be weary of taking the response as absolute truth. It's usually possible to see by looking at the research itself of how much weight to put on it, but AI may give an equally confident answer to something that is broadly researched vs something that's just one person's opinion.
