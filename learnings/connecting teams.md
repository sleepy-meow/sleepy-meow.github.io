...
# the shared-consciousness answer (Team of Teams)
...
# the boundary-spanning answer (Teaming)

Edmondson's *Teaming* names *why* the gaps between teams are so treacherous: people unconsciously favour their own group and take their own knowledge for granted. *"We don't know who discovered water, but it wasn't the fish."* Experts live in different **"thought worlds"** and don't even notice the assumptions they're not sharing. She sorts the gaps into three kinds:

- **Physical / distance boundaries** — different sites, time zones, 2,000 feet of rock.
- **Status boundaries** — the doctor/nurse, senior/junior gap that stops the lower-status person raising the thing they can see (this is [[psychological safety]] operating *across* a rank gap).
- **Knowledge boundaries** — the engineer/marketer, designer-in-Beijing/designer-in-Boston gap, where the same words carry different meanings.

The trap: instant communication tools give a *false confidence* that collaboration is "a click away." People sit in endless meetings, work hard, and the project still fails — because they never actually crossed the boundary, they just talked across it. Spanning it takes deliberate work: getting curious about the other side's assumptions, and the same trust and safety that teaming inside one team needs.
