...
# what to do about it
While many of the things described below do require formal authority, it can be useful is to simply be aware of these things, to not take *"this is just how it is and there's nothing we can do about it"* as an answer.
...
After a certain level of courage has been reached, this can become self sustaining (todo: find the research paper)
